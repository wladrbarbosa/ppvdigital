...
void main() {
  group('TarefaHabitoQtdModel Cycle Reset Calculations', () {
    test('Daily cycle reset always starts at 00:00:00 of reference day', () {
      ...
      final end = TarefaHabitoQtdModel.calculateEndPeriod(
        start,
        'dias',
        1,
      );

      expect(start, equals(DateTime(2026, 8, 4, 0, 0, 0)));
      expect(end, equals(DateTime(2026, 8, 5, 0, 0, 0)));
      ...
      expect(nextStart, equals(DateTime(2026, 8, 5, 0, 0, 0)));
    });

    test('Weekly cycle reset always starts at 00:00:00 of Monday', () {
      final created = DateTime(2026, 8, 1, 10, 0, 0); // Saturday
      ...
      expect(start, equals(DateTime(2026, 8, 3, 0, 0, 0)));
      expect(end, equals(DateTime(2026, 8, 10, 0, 0, 0)));
    });

    test('Monthly cycle reset always starts at 00:00:00 on 1st of month', () {
      final created = DateTime(2026, 1, 15, 12, 0, 0);
      final refMidMonth = DateTime(2026, 8, 18, 19, 0, 0);
      ...
      expect(start, equals(DateTime(2026, 8, 1, 0, 0, 0)));
      expect(end, equals(DateTime(2026, 9, 1, 0, 0, 0)));
    });

    test('Yearly cycle reset always starts at 00:00:00 on Jan 1st', () {
      final created = DateTime(2024, 5, 20, 8, 0, 0);
      ...
      expect(start, equals(DateTime(2026, 1, 1, 0, 0, 0)));

...
| 3. Serviço de Restauração Segura (`RestoreService`) | IN_PROGRESS | Implementar restauração em 4 etapas ordenadas por dependência, validação prévia de checksum, reconstituição do Drift e testes unitários |

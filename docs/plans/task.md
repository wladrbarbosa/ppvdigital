...
| 8. Conexão Google Drive no Web & Configuração de Client ID | COMPLETED | Suporte a `google_sign_in: 7.2.0` no Web via `authorizationClient.authorizeScopes`, diálogo interativo Pastel para Client ID, reatividade MobX com observables dedicados e 279/279 testes aprovados |

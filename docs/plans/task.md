...
| 6. Interface de Usuário no `ConfiguracoesModalWidget` | IN_PROGRESS | Criar seção de Backup/Restauração no modal de configurações e diálogo interativo de progresso/resumo com Design System Pastel |
